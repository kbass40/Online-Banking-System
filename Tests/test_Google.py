...
def test_fail_sell_stocks_from_raw_int_quantity_type():
    with pytest.raises(TypeError):
        GOOGLE.user_buys_stocks(25)
        
def test_jsonify():
	dict = [("-282050.0","5000"), ("-451280.0", "8000")]
	json = GOOGLE.jsonify(dict)
