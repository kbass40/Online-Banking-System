...
def test_authenticated_create_and_delete_user():
    myDB = AuthDB.AuthDatabase()
    myDB.create_new_user('temp2@gmail.com','password')
    auth_id = myDB.authenticate_user_via_email_password('temp2@gmail.com','password')
...
if __name__ == '__main__':
    ...
    if successful:
        print("All integration tests ran successfully")
    else:
        print("Integration tests did not run successfully")
